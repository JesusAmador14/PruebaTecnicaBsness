...
<body>
	<div class="contenedor">
		...
		<div class="barra_principal">
			<div class="img">
				<img src="https://kabik.mx/assets/logo/logo_original.png" alt="Image" style="display:block;font-size:14px;width: 150px;" class="img180x28" />
			</div>
		</div>
			...
			<div class="detail_all">
				<div class="detail_subtitulo colum centrar_vertical centrar_horizontal">
					<div class="info_important row">
						<h3>Correo: &nbsp;&nbsp;</h3>
						<h3 class="mayuscula"><span id='correo'><?php echo $email; ?></span></h3>
					</div>
					<br>
					<div class="row">
						<h4>Contraseña: &nbsp;&nbsp;</h4>
